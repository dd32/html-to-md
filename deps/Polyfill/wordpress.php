...
if ( ! class_exists( 'WP_HTML_Processor' ) ) {
	...
	require_once __DIR__ . '/../html-api/class-wp-html-active-formatting-elements.php';
	require_once __DIR__ . '/../html-api/class-wp-html-attribute-token.php';
	require_once __DIR__ . '/../html-api/class-wp-html-decoder.php';
	require_once __DIR__ . '/../html-api/class-wp-html-doctype-info.php';
	require_once __DIR__ . '/../html-api/class-wp-html-open-elements.php';
	require_once __DIR__ . '/../html-api/class-wp-html-processor-state.php';
	require_once __DIR__ . '/../html-api/class-wp-html-span.php';
	require_once __DIR__ . '/../html-api/class-wp-html-stack-event.php';
	require_once __DIR__ . '/../html-api/class-wp-html-token.php';
	require_once __DIR__ . '/../html-api/html5-named-character-references.php';
	require_once __DIR__ . '/../html-api/class-wp-html-unsupported-exception.php';
	...
	require_once __DIR__ . '/../html-api/class-wp-html-processor.php';
}
